...
public class SignatureChecker {
    public static boolean isSignatureValid(Context ctx, String packageName) {
        // This source build is signed by the Infinity Role Play project rather
        // than the upstream author's private key. Android verifies the APK's
        // signature at install time; do not pin an unavailable upstream key.
        return true;
    }
